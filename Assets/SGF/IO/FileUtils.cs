    ...
    public class FileUtils
    {
        ...
        public static int SaveFile(string fullpath, byte[] content)
        {
            ...
            if (!Directory.Exists(dir))
            {
                ...
                {
                    MyLogger.LogError(LOG_TAG, "SaveFile() CreateDirectory Error! Dir:{0}, Error:{1}", dir, e.Message);
                    return -1;
                }
            ...
            {
                MyLogger.LogError(LOG_TAG, "SaveFile() Path:{0}, Error:{1}", fullpath, e.Message);
                fs.Close();
                return -1;
            }
